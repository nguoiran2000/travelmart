...
function FriendlyChat() {
  ...
  this.signInButtonEmail = document.getElementById('sign-in-email');
  ...
  this.signInButtonEmail.addEventListener('click', this.signInEmail.bind(this));
...
// Signs-in Friendly Chat.
FriendlyChat.prototype.signInFacebook = function(facebookUser) {
  // TODO(DEVELOPER): Sign in Firebase with credential from the Facebook user.
...
FriendlyChat.prototype.onAuthStateChanged = function(user) {
  if (user) { // User is signed in!
    ...
    this.signInButtonEmail.setAttribute('hidden', 'true');
    ...
    this.signInButtonEmail.removeAttribute('hidden');
  }
};
